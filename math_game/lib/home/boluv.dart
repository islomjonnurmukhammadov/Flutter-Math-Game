...
class BoluvPage extends StatefulWidget {
  const BoluvPage({super.key});

  @override
  State<BoluvPage> createState() => _BoluvPageState();
}

class _BoluvPageState extends State<BoluvPage> {
